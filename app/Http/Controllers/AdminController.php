...
class AdminController extends Controller
{
    ...
    public function addQuiz()
    {
        ...
        if ($adminUser) {
            ...
            return view('4_add-quiz', ['name' => $adminUser->name,'categories' => $category,'totalMcqs' => $totalMcqs,'quiz' => $quiz,]);
        } else {
            return redirect('admin-login');
    ...
    public function addMcq(Request $request)
    {
        ...
        $request->validate([
            ...
            'option_c' => 'required',
            'option_d' => 'required',
            'currect_ans' => 'required|in:option-a,option-b,option-c,option-d',
        ]);
