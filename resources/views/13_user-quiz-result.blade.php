...
<body>
   ...
   <div class=" mt-10 flex flex-col items-center w-full min-h-screen font-serif">
            <h1 class="font-medium text-xl text-green-800 text-center">Quiz Result List : </h1>
            <ul class="border border-blue-900 mt-5 rounded-2xl py-3 w-200">
                ...
                <li class="even:bg-yellow-200 p-2 pl-9">
                    <ul class="flex justify-between">
                        ...
                        @if($item->correct_answer == 'Correct')
                        <li class="w-32 text-green-500 font-bold">Correct</li>
                        @else
                        <li class="w-32 text-red-500 font-bold">Incorrect</li>
                        @endif
                    </ul>
                </li>
                @endforeach
