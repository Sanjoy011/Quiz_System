...
<body>
   <div class="flex flex-col mt-30 items-center bg-amber-100 border-4 border-amber-600 m-50 justify-center w-180 font-serif rounded-xl border-double ">
        ...
        <h2 class="mt-2 text-2xl font-bold underline">{{$data['name']}}</h2>
        <p class="mt-3 text-xl ">has Successfully completed the</p>
        <h3 class="mt-3 text-2xl ">{{$data['quiz']}}</h3>
