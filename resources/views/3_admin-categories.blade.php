...
<body>
    ...
    <div class="text-green-900 bg-emerald-300 text-sm">{{session('addcategory')}}</div>
    @endif

    <!-- Add categories items -->
    <div class=" bg-gray-200 flex flex-col items-center min-h-screen  pt-8 ">
        ...
        <div class="w-200">
            <h1 class="text-2xl text-amber-800 mb-4">Category List: </h1>
